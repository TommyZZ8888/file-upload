          ...
          <slot name="uploadContent">
            ...
            <div class="el-upload__content">
              ...
              <div class="el-upload__text">
                <p style="font-size: 15px; color: #797979" v-if="fileList.length > 0">Click blank area to continue
                  uploading</p>
                <p style="font-size: 15px; color: #797979" v-else>Drag file here or click to upload</p>
                <p style="color: #999999">Supports {{ props.accept }} format, single file max {{
                    maxSize / 1024 / 1024
                  }}MB</p>
              </div>
            </div>
